...
class PagerGridViewItemAdapter<VH : PagerGridView.ItemViewHolder>(
    private val pageItemCount: Int,
    ...
    override fun onBindViewHolder(
        ...
        val realPosition = (pageIndex * pageItemCount) + holder.adapterPosition
